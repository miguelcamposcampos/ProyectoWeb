...
export class ProveedoresComponent implements OnInit {
  ...
  onGenerarReporte(){
    ...
    const params = {
      ...
      f1 :  this.formatDate.transform(data.fechaInicio, ConstantesGenerales._FORMATO_FECHA_BUSQUEDA),
      f2 :  this.formatDate.transform(data.fechaFin, ConstantesGenerales._FORMATO_FECHA_BUSQUEDA), 
    }
  
    this.swal.mensajePreloader(true); 
    this.reporteService.generarReporteProveedor(params).subscribe((resp) => { 
      if(resp){ 
