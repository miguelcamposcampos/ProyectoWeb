...
@Component({
  selector: 'app-compra-proveedor-daot-analitico',
  templateUrl: './compra-proveedor-daot-analitico.component.html'
})
export class CompraProveedorDaotAnaliticoComponent implements OnInit {
