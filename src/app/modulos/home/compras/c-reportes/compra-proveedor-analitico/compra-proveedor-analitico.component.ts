...
@Component({
  selector: 'app-compra-proveedor-analitico',
  templateUrl: './compra-proveedor-analitico.component.html' 
})
export class CompraProveedorAnaliticoComponent implements OnInit {
