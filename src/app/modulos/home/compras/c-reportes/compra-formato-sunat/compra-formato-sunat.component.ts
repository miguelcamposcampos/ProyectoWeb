...
@Component({
  selector: 'app-compra-formato-sunat',
  templateUrl: './compra-formato-sunat.component.html'
})
export class CompraFormatoSunatComponent implements OnInit {
  ...
  public builform(){ 
    this.Form = new FormGroup({ 
      ...
      Agrupado : new FormControl( {nombre : 'SIN AGRUPAR', codigo: ''}),
    })
  }
  ...
  onCargarCombos(){  
    this.arrayAgrupado = [
      {nombre : 'SIN AGRUPAR', codigo: null},
      {nombre : 'SERIE', codigo: 'serie'}, 
    ]
  ...
  onGenerarReporte(){
    ...
    const params = {
      ...
      agrupador : data.Agrupado.codigo,
