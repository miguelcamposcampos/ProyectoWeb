...
@Component({
  selector: 'app-compra-proveedor-daot-resumen',
  templateUrl: './compra-proveedor-daot-resumen.component.html'
})
export class CompraProveedorDaotResumenComponent implements OnInit {
