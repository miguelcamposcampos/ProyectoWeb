...
@Component({
  selector: 'app-ventas-por-producto-rep-resumen',
  templateUrl: './ventas-por-producto-rep-resumen.component.html'
})
export class VentasPorProductoRepResumenComponent implements OnInit {
