...
@Component({
  selector: 'app-ventas-por-cliente-daot-rep-analitico',
  templateUrl: './ventas-por-cliente-daot-rep-analitico.component.html'
})
export class VentasPorClienteDAOTRepAnaliticoComponent implements OnInit {
  ...
  onGenerarReporte(){ 
    ...
    this.spinner.show();
    this.reporteService.generarReporteVxCDAOTanalitico(Params).subscribe((resp) => { 
      if(resp){  
