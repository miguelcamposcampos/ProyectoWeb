...
@Component({
  selector: 'app-ventas-por-vendedor-rep-analitico',
  templateUrl: './ventas-por-vendedor-rep-analitico.component.html'
})
export class VentasPorVendedorRepAnaliticoComponent implements OnInit {
  ...
  onGenerarReporte(){ 
    ...
    this.reporteService.generarReporteVendedorAnalitico(Params).subscribe((resp) => { 
      if(resp){  
