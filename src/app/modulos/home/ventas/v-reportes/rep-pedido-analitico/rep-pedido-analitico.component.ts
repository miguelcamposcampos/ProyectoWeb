...
@Component({
  selector: 'app-rep-pedido-analitico',
  templateUrl: './rep-pedido-analitico.component.html'
})
export class RepPedidoAnaliticoComponent implements OnInit {
  ...
  onGenerarReporte(){ 
    ...
    this.spinner.show();
    this.reporteService.generarReportePedidosAnalitico(Params).subscribe((resp) => { 
      if(resp){  
