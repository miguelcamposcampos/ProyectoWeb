...
@Component({
  ...
  templateUrl: './rep-venta.component.html'
})
export class RepVentaComponent implements OnInit {
  ...
  onCargarDropwdon(){
    ...
    obsDatos.subscribe((response) => {
      ...
      this.arrayEstablecimientos = response[1];  
  ...
  onGenerarReporte(){  
    ...
    if(!this.idEstablecimientoSeleccionado){
    ...
    const Params = { 
      ...
      establecimiento: this.idEstablecimientoSeleccionado,
